...
export class CategoriaProfesor {
  categorias = [
    { nombre: 'Juegos', imgSrc: 'https://img.freepik.com/vector-gratis/elementos-concepto-streamer-juego-ilustrados_23-2148932487.jpg' },
    { nombre: 'Cursos', imgSrc: 'https://img.freepik.com/vector-gratis/ilustracion-concepto-formacion-linea_114360-22546.jpg' },
    { nombre: 'Biblioteca', imgSrc: 'https://img.freepik.com/vector-gratis/gente-interior-sala-libreria_107791-29869.jpg' },
    { nombre: 'Módulos', imgSrc: 'https://img.freepik.com/vector-gratis/fondo-creativo-negocios_23-2147693122.jpg' }
  ];
...
categoriaEditada = { nombre: '', imgSrc: '' };
  ...
  guardarEdicion() {
      if (this.categoriaEditada.nombre.trim() !== '') {
          const categoriaIndex = this.categorias.findIndex(cat => cat.nombre === this.categoriaEditada.nombre);
          if (categoriaIndex !== -1) {
