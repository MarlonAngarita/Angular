...
export class ForoEstudiantes {
  ...
  publicaciones: { autor: string; tiempo: string; titulo: string; contenido: string; imagen: string }[] = [
    {
      ...
      imagen: 'https://img.freepik.com/vector-premium/avatar-personaje-dibujos-animados_24911-56974.jpg'
    }
  ];
  ...
  publicarPost() {
    if (this.tituloPost.trim() && this.contenidoPost.trim()) {
        ...
        console.log("Nueva publicación agregada:", nuevaPublicacion); /* ✅ Verifica si el título se está guardando */
